  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-fog dark:bg-steel font-body text-ink dark:text-fog">
        ...
        <div className="mx-auto max-w-5xl px-4 py-4 sm:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-6 items-center">
              <a href="/" className="text-sm font-semibold text-steel dark:text-fog/70 hover:text-ink dark:hover:text-mint transition">
                Verify
              </a>
              <a href="/pricing" className="text-sm font-semibold text-ink dark:text-fog transition">
                Pricing
              </a>
              <a href="/login" className="text-sm font-semibold text-steel dark:text-fog/70 hover:text-ink dark:hover:text-mint transition">
                Sign In
              </a>
      ...
      <main className="relative mx-auto flex w-full max-w-5xl flex-col px-4 pb-12 pt-8 sm:px-8">
        {/* Header */}
        <header className="mb-12 animate-rise rounded-3xl border border-steel/10 dark:border-steel/40 bg-white/70 dark:bg-ink/80 p-6 shadow-soft backdrop-blur-md sm:p-8">
          <h1 className="font-display text-3xl font-bold leading-tight text-ink dark:text-fog sm:text-4xl mb-3">
            Simple, Transparent Pricing
          </h1>
          <p className="mb-4 text-xl font-semibold text-ink dark:text-fog sm:text-2xl">
            Scale with your organization
          </p>
          <p className="mt-3 max-w-3xl text-sm text-steel/80 dark:text-fog/60 sm:text-base">
